...
const p1 = document.getElementById('place1'); //Demo
// console.log(1);
// console.log(2);
// setTimeout(()=>{
...
getURL('https://jsonplaceholder.typicode.com/todos').then(r => {
  console.log(r);
  return getURL('data.json');
}).then(r => {
  console.log(r);
  return getURL('data2.json');
}).then(r => console.log(r)).then(r => console.log("finished")).catch(e => console.log(e));
